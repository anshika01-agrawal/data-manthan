...
import { OceanographicAnalysis } from "@/components/oceanographic-analysis"
...
export default function OceanographicAnalysisPage() {
        ...
        <SlidingContent delay={400} className="text-center py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">
              Comprehensive ocean data analysis with advanced modeling and predictive insights
            </p>
